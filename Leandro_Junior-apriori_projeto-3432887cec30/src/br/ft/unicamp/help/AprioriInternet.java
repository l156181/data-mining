 ...
 */
public class AprioriInternet extends Observable {


    public static void main(String[] args) throws Exception {
        AprioriInternet ap = new AprioriInternet(args);
    }
    ...
    public  AprioriInternet(String[] args, Observer ob) throws Exception
    {
    	usedAsLibrary = true;
    	configure(args);
    	this.addObserver(ob);
     ...
     */
    public  AprioriInternet(String[] args) throws Exception
    {
        configure(args);
        go();
    }
    ...
    {        
        ...
        else transaFile = "./Arquivos/chess.dat"; // default
